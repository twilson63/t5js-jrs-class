(function (global, factory) {
  ...
  var acorn$1 = __commonjs(function (module, exports, global) {
  ...
  pp.parseExpression = function (noIn, refDestructuringErrors) {
    ...
    if (this.type === _tokentype.types.comma) {
      ...
      while (this$1.eat(_tokentype.types.comma)) node.expressions.push(this$1.parseMaybeAssign(noIn, refDestructuringErrors));
  ...
  pp.parseMaybeUnary = function (refDestructuringErrors, sawUnary) {
    ...
    if (this.type.prefix) {
      ...
      while (this$1.type.postfix && !this$1.canInsertSemicolon()) {
        ...
        node.operator = this$1.value;
        node.prefix = false;
        node.argument = expr;
        this$1.checkLVal(expr);
        this$1.next();
        expr = this$1.finishNode(node, "UpdateExpression");
      }
    }
  ...
  pp.parseSubscripts = function (base, startPos, startLoc, noCalls) {
    ...
    for (;;) {
      if (this$1.eat(_tokentype.types.dot)) {
        var node = this$1.startNodeAt(startPos, startLoc);
        node.object = base;
        node.property = this$1.parseIdent(true);
        node.computed = false;
        base = this$1.finishNode(node, "MemberExpression");
      } else if (this$1.eat(_tokentype.types.bracketL)) {
        var node = this$1.startNodeAt(startPos, startLoc);
        node.object = base;
        node.property = this$1.parseExpression();
        node.computed = true;
        this$1.expect(_tokentype.types.bracketR);
        base = this$1.finishNode(node, "MemberExpression");
      } else if (!noCalls && this$1.eat(_tokentype.types.parenL)) {
        var node = this$1.startNodeAt(startPos, startLoc);
        node.callee = base;
        node.arguments = this$1.parseExprList(_tokentype.types.parenR, false);
        base = this$1.finishNode(node, "CallExpression");
      } else if (this$1.type === _tokentype.types.backQuote) {
        var node = this$1.startNodeAt(startPos, startLoc);
        node.tag = base;
        node.quasi = this$1.parseTemplate();
        base = this$1.finishNode(node, "TaggedTemplateExpression");
      } else {
        return base;
      }
    }
  ...
  pp.parseParenAndDistinguishExpression = function (canBeArrow) {
    ...
    if (this.options.ecmaVersion >= 6) {
      ...
      while (this$1.type !== _tokentype.types.parenR) {
        first ? first = false : this$1.expect(_tokentype.types.comma);
        if (this$1.type === _tokentype.types.ellipsis) {
          spreadStart = this$1.start;
          exprList.push(this$1.parseParenItem(this$1.parseRest()));
          break;
        } else {
          if (this$1.type === _tokentype.types.parenL && !innerParenStart) {
  ...
  pp.parseTemplate = function () {
    ...
    node.quasis = [curElt];
    while (!curElt.tail) {
      this$1.expect(_tokentype.types.dollarBraceL);
      node.expressions.push(this$1.parseExpression());
      this$1.expect(_tokentype.types.braceR);
  ...
  pp.parseObj = function (isPattern, refDestructuringErrors) {
    ...
    node.properties = [];
    this.next();
    while (!this$1.eat(_tokentype.types.braceR)) {
      if (!first) {
        this$1.expect(_tokentype.types.comma);
        if (this$1.afterTrailingComma(_tokentype.types.braceR)) break;
      } else first = false;
      ...
      if (this$1.options.ecmaVersion >= 6) {
        ...
        if (!isPattern) isGenerator = this$1.eat(_tokentype.types.star);
      }
  ...
  pp.parseExprList = function (close, allowTrailingComma, allowEmpty, refDestructuringErrors) {
    ...
    while (!this$1.eat(close)) {
      ...
      var elt = undefined;
      if (allowEmpty && this$1.type === _tokentype.types.comma) elt = null;else if (this$1.type === _tokentype.types.ellipsis) {
        elt = this$1.parseSpread(refDestructuringErrors);
        if (this$1.type === _tokentype.types.comma && refDestructuringErrors && !refDestructuringErrors.trailingComma) {
  ...
  pp.parseBindingList = function (close, allowEmpty, allowTrailingComma, allowNonIdent) {
    ...
    var elts = [],
        first = true;
    while (!this$1.eat(close)) {
      if (first) first = false;else this$1.expect(_tokentype.types.comma);
      if (allowEmpty && this$1.type === _tokentype.types.comma) {
        elts.push(null);
      } else if (allowTrailingComma && this$1.afterTrailingComma(close)) {
        break;
      } else if (this$1.type === _tokentype.types.ellipsis) {
        var rest = this$1.parseRest(allowNonIdent);
        this$1.parseBindingListItem(rest);
        elts.push(rest);
        if (this$1.type === _tokentype.types.comma) this$1.raise(this$1.start, "Comma is not permitted after the rest element");
        this$1.expect(close);
        break;
      } else {
  ...
  pp.parseTopLevel = function (node) {
    ...
    while (this$1.type !== _tokentype.types.eof) {
  ...
  pp.isLet = function () {
    ...
    if (_identifier.isIdentifierStart(nextCh, true)) {
      for (var pos = next + 1; _identifier.isIdentifierChar(this$1.input.charCodeAt(pos, true)); ++pos) {}
  ...
  pp.parseSwitchStatement = function (node) {
    ...
    for (var cur, sawDefault = false; this$1.type != _tokentype.types.braceR;) {
      if (this$1.type === _tokentype.types._case || this$1.type === _tokentype.types._default) {
        var isCase = this$1.type === _tokentype.types._case;
        ...
        this$1.expect(_tokentype.types.colon);
      } else {
  ...
  pp.parseLabeledStatement = function (node, maybeName, expr) {
    ...
    for (var i = this$1.labels.length - 1; i >= 0; i--) {
  ...
  pp.parseVar = function (node, isFor, kind) {
    ...
    for (;;) {
      ...
      if (this$1.eat(_tokentype.types.eq)) {
        decl.init = this$1.parseMaybeAssign(isFor);
      } else if (kind === "const" && !(this$1.type === _tokentype.types._in || this$1.options.ecmaVersion >= 6 && this$1.isContextual("of"))) {
        this$1.unexpected();
      } else if (decl.id.type != "Identifier" && !(isFor && (this$1.type === _tokentype.types._in || this$1.isContextual("of")))) {
        this$1.raise(this$1.lastTokEnd, "Complex binding patterns require an initialization value");
      } else {
        decl.init = null;
      }
      node.declarations.push(this$1.finishNode(decl, "VariableDeclarator"));
      if (!this$1.eat(_tokentype.types.comma)) break;
    }
    return node;
  };
  ...
  pp.parseClass = function (node, isStatement) {
    ...
    this.expect(_tokentype.types.braceL);
    while (!this$1.eat(_tokentype.types.braceR)) {
      if (this$1.eat(_tokentype.types.semi)) continue;
      var method = this$1.startNode();
      var isGenerator = this$1.eat(_tokentype.types.star);
      var isMaybeStatic = this$1.type === _tokentype.types.name && this$1.value === "static";
      this$1.parsePropertyName(method);
      method["static"] = isMaybeStatic && this$1.type !== _tokentype.types.parenL;
      if (method["static"]) {
        if (isGenerator) this$1.unexpected();
        isGenerator = this$1.eat(_tokentype.types.star);
        this$1.parsePropertyName(method);
      }
      method.kind = "method";
      var isGetSet = false;
      if (!method.computed) {
        ...
        if (!isGenerator && key.type === "Identifier" && this$1.type !== _tokentype.types.parenL && (key.name === "get" || key.name === "set")) {
          isGetSet = true;
  ...
  pp.parseExportSpecifiers = function () {
    ...
    while (!this$1.eat(_tokentype.types.braceR)) {
      ...
      node.local = this$1.parseIdent(this$1.type === _tokentype.types._default);
  ...
  pp.parseImportSpecifiers = function () {
    ...
    while (!this$1.eat(_tokentype.types.braceR)) {
      ...
      var node = this$1.startNode();
      node.imported = this$1.parseIdent(true);
      if (this$1.eatContextual("as")) {
        node.local = this$1.parseIdent();
      } else {
        node.local = node.imported;
        if (this$1.isKeyword(node.local.name)) this$1.unexpected(node.local.start);
        if (this$1.reservedWordsStrict.test(node.local.name)) this$1.raise(node.local.start, "The keyword '" + node.local.name + "' is reserved");
      }
      this$1.checkLVal(node.local, true);
      nodes.push(this$1.finishNode(node, "ImportSpecifier"));
    }
    return nodes;
  };
  ...
  pp.skipBlockComment = function () {
    ...
    if (this.options.locations) {
      ...
      var match = undefined;
      while ((match = _whitespace.lineBreakG.exec(this$1.input)) && match.index < this$1.pos) {
        ++this$1.curLine;
  ...
  pp.readRegexp = function () {
    ...
    for (;;) {
      ...
      if (_whitespace.lineBreak.test(ch)) this$1.raise(start, "Unterminated regular expression");
      if (!escaped) {
  ...
  pp.readString = function (quote) {
    ...
    for (;;) {
      ...
      if (ch === 92) {
        ...
        if (_whitespace.isNewLine(ch)) this$1.raise(this$1.start, "Unterminated string constant");
        ++this$1.pos;
      }
    }
  ...
  pp.readTmplToken = function () {
    ...
    for (;;) {
      ...
      if (ch === 96 || ch === 36 && this$1.input.charCodeAt(this$1.pos + 1) === 123) {
        // '`', '${'
        if (this$1.pos === this$1.start && this$1.type === _tokentype.types.template) {
          if (ch === 36) {
            this$1.pos += 2;
            return this$1.finishToken(_tokentype.types.dollarBraceL);
          } else {
            ++this$1.pos;
            return this$1.finishToken(_tokentype.types.backQuote);
          }
        }
        out += this$1.input.slice(chunkStart, this$1.pos);
        return this$1.finishToken(_tokentype.types.template, out);
      }
      if (ch === 92) {
        // '\'
        out += this$1.input.slice(chunkStart, this$1.pos);
  ...
  pp.readWord1 = function () {
    ...
    while (this$1.pos < this$1.input.length) {
      ...
      if (_identifier.isIdentifierChar(ch, astral)) {
        ...
        if (!(first ? _identifier.isIdentifierStart : _identifier.isIdentifierChar)(esc, astral)) this$1.raise(escStart, "Invalid Unicode escape");
  ...
  var require$$0 = (acorn$1 && typeof acorn$1 === 'object' && 'default' in acorn$1 ? acorn$1['default'] : acorn$1);
  ...
  var require$$0$1 = (xhtml && typeof xhtml === 'object' && 'default' in xhtml ? xhtml['default'] : xhtml);

  var inject = __commonjs(function (module) {
  'use strict';

  var XHTMLEntities = require$$0$1;
  ...
  var require$$1 = (inject && typeof inject === 'object' && 'default' in inject ? inject['default'] : inject);

  var index = __commonjs(function (module) {
  'use strict';

  module.exports = require$$1(require$$0);
  });

  var acornJsx = (index && typeof index === 'object' && 'default' in index ? index['default'] : index);
